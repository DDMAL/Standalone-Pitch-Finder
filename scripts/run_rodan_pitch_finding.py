...
As in run_pitch_finding.py, --output also accepts a directory and --debug-viz
can be passed bare to name the overlay after --output.
"""
...
def run(image_path: Path, ic_xml_path: Path, staff_json_path: Path, output_path: Path,
        debug_viz: str = None, debug_scale: float = 2.5):
